...
local mia_paths = {
    "images/saveslot_portraits/%s",
    "images/selectscreen_portraits/%s",
    "images/selectscreen_portraits/%s_silho",
    "bigportraits/%s_none",
    "bigportraits/%s",
    "images/names_%s",
    "images/names_gold_%s",
    "images/avatars/avatar_%s",
    "images/avatars/avatar_ghost_%s",
    "images/avatars/self_inspect_%s"
}
